<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="DetalhesConta.aspx.cs" Inherits="IdealService.DetalhesConta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="headling pb-5 bg-dark">
        ...
        <div class="container py-2">
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light text-center py-3">Detalhes da Conta</h1>
                    <!-- Div nome -->
                    <div class="form-row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <asp:TextBox ID="txtNome" runat="server" MaxLength="100"
                                CssClass="form-control" placeholder="Nome" Enabled="false"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-row">
                        <!-- Email -->
                        <div class="form-group col-lg-7 col-md-12 col-sm-12 col-12">
                            <label>Email:</label>
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" type="email" MaxLength="100" CssClass="form-control"
                                placeholder="Email"  Enabled="false"></asp:TextBox>
                        </div>
                        <!-- TELEFONE -->
                        <div class="form-group col-lg-5 col-md-12 col-sm-12 col-12">
                            ...
                            <asp:TextBox ID="txtTelefone" runat="server" type="number" MaxLength="14" CssClass="form-control"
                                placeholder="16 91234 5678" value="" Enabled="false"></asp:TextBox>
                        </div>
                    </div>
                    <!-- Div Cidade / Estado -->
                    <div class="form-row">
                        <div class="form-group col-lg-8 col-md-8 col-sm-8 col-8">
                            ...
                            <div class=" text-left">
                                ...
                                <asp:TextBox ID="txtCep" runat="server" MaxLength="8" CssClass="form-control"
                                    placeholder="CEP" value="" Enabled="false"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="text-right col-md-12">
                            <!-- Resultado -->
                            <asp:Label ID="lblResultado" runat="server"  Enabled="false"></asp:Label>
                        </div>
                    </div>
                    <!-- Div Botões -->
                    <div class="form-row">
